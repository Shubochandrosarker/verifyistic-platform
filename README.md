...
- [ ] **Phase 9** — WordPress: cloud/self-hosted connector, site credentials, webhook receiver, WooCommerce hooks (local WP test env ready)
- [ ] Phase 10–14 — per `21-IMPLEMENTATION-ROADMAP.md`
